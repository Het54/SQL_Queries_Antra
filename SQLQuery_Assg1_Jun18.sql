...
-- i) NAME: LL Crankarm  --  COLOR: Black
-- ii) NAME: ML Crankarm  --  COLOR: Black
-- iii) NAME: HL Crankarm  --  COLOR: Black
-- iv) NAME: Chainring Bolts  --  COLOR: Silver
-- v) NAME: Chainring Nut  --  COLOR: Silver
-- vi) NAME: Chainring  --  COLOR: Black
